...
export const features = [
  {
    ...
    image: 'https://i.pinimg.com/736x/a1/8d/01/a18d010e762e2de95a11c076aaacc89d.jpg',
    tag: 'Venue',
    title: 'Auto sales in April increase 21% year-on-year',
    rating: 4.9,
    reviews: 124,
    price: '55tr VND/ngày',
  },
...
export const reviews = [
  ...
  {
    stars: 5,
    content: 'Những sản phẩm thật chất lượng và giá vô cùng hạt dẻ như tên của trang wed',
    name: 'Emily & James',
    avatar: 'https://i.pravatar.cc/50?img=2',
  },
  {
    stars: 4,
    content: 'Nhiều dịch vụ và sản phẩm đa dạng, dễ dàng tìm kiếm và đặt chúng',
    name: 'Alex & Jordan',
